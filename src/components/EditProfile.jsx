      ...
      <div className="mx-36 pt-6 w-96">
        ...
        <div className="flex  w-50  gap-15">
          ...
          <fieldset className="fieldset">
            ...
            <select value={gender} className="select w-25" onChange={(e) => setGender(e.target.value)}>
        ...
        <div className="pt-5 ml-28 relative">
          ...
          <button className="btn btn-outline btn-success" onClick={saveProfile}>Save</button>
        </div>
      </div>
      <Card data={{ firstName, lastName, bio , age , gender }} className="!ml-24 " />
    </>
  )
}
